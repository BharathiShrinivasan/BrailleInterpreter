...
/* note: Keep Arduino Tx, Rx pin in INPUT mode, and dump a blank into the arduino connect tx-tx, rx-rx */
...
int8_t receivedData=0x00;
void UART4_IRQHandler(void){   // read reciever buffer
		receivedData=UART4->DR;
}
